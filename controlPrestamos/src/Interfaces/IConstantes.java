...
public interface IConstantes
{
	...
	final int colega = 1;
	/**
	 * Constante de estudiante
	 */
	final int estudiante = 2;
	/**
	 * Constante para cantCategoriasPersona
	 */
	final int cantCategoriasPersona = 3;
	
	/**
	 * Constante para categoriaLibro
	 */
	final int categoriaLibro = 0;
	/**
	 * Constante para categoriasRevista
	 */
	final int categoriaRevista = 1;
	/**
